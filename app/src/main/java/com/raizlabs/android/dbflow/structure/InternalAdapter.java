...
public interface InternalAdapter<TModel extends Model> {
	 ...
	 *
	 * @param models
	 * 		The {@link Collection} of models to save.
	 */
	 ...
	 * @param start
	 * 		The starting index for this bind.
	 */
	void bindToInsertStatement(DatabaseStatement sqLiteStatement, TModel model, @IntRange(from = 0, to = 1) int start);
	 ...
	 *
	 * @param contentValues
	 * 		The content values to fill.
	 * @param model
	 * 		The model values to put on the contentvalues
	 */
	 ...
	 * 		The content values to fill.
	 * @param model
	 * 		The model values to put on the content values.
	 */
