...
public class ShortProperty
		extends BaseProperty<ShortProperty> {
	...
	public ShortProperty(Class<? extends Model> table, String columnName) {
		...
		this(
				table,
				new NameAlias.Builder(columnName).build()
			);
	}
	...
	public ShortProperty(Class<? extends Model> table, String columnName, String aliasName) {
		...
		this(
				table,
				new NameAlias.Builder(columnName).as(aliasName)
												 .build()
			);
	}
	...
	public ShortProperty concatenate(IProperty iProperty) {
		...
		return new ShortProperty(
				table,
				NameAlias.joinNames(
						Condition.Operation.CONCATENATE,
						nameAlias.fullName(),
						iProperty.toString()
								   )
		);
