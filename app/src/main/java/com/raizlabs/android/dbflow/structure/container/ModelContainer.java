 ...
 */
public interface ModelContainer<TModel extends Model, DataClass>
		extends Model {
	...
	/**
	 * @param inValue
	 * 		The data to construct a new instance from
	 * @param columnClass
	 * 		The Model type
	 *
	 ...
	 * 		The key to use.
	 * @param <T>
	 * 		The return type we cast the return to.
	 *
