 ...
 */
public abstract class BaseModelView<TModel extends Model>
		extends NoModificationModel {
	...
	public ModelViewAdapter<? extends Model, BaseModelView<TModel>> getModelViewAdapter() {
		...
		if (adapter == null) {
			adapter = ((ModelViewAdapter<? extends Model, BaseModelView<TModel>>) FlowManager.getModelViewAdapter(getClass()));
		}
		return adapter;
	}
