 ...
 */
public class Index<TModel extends Model>
		implements Query {
	 ...
	 *
	 * @param unique
	 * 		true if unique. If created again, a {@link android.database.SQLException} is thrown.
	 *
	 ...
	 *
	 * @param table
	 * 		The table to execute index on.
	 * @param properties
	 * 		The properties to create an index for.
	 *
	 * @return This instance.
	 */
	 ...
	 * 		The table to execute index on.
	 * @param columns
	 * 		The columns to create an index for.
	 *
	 * @return This instance.
	 */
	...
	public void enable() {
		...
		enable(FlowManager.getDatabaseForTable(table)
						  .getWritableDatabase());
	}
	...
	public String getQuery() {
		...
		return new QueryBuilder("CREATE ").append(isUnique ?
														  "UNIQUE " :
														  "")
