 ...
 */
public class TriggerMethod<TModel extends Model>
		implements Query {
	 ...
	 *
	 * @param triggerLogicQuery
	 * 		The query to run for the BEGIN..END of the trigger
	 *
	 * @return This trigger
	 */
	public CompletedTrigger<TModel> begin(Query triggerLogicQuery) {

		return new CompletedTrigger<>(
				this,
				triggerLogicQuery
		);
	}
	...
	public String getQuery() {
		...
		queryBuilder.appendSpaceSeparated("ON")
					.append(FlowManager.getTableName(onTable));
