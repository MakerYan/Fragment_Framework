...
public class Case<TReturn>
	...
	public CaseCondition<TReturn> when(SQLCondition sqlCondition) {
		...
		CaseCondition<TReturn> caseCondition = new CaseCondition<>(
				this,
				sqlCondition
		);
	...
	/**
	 * @param columnName
	 * 		The name of the case that we return in a column.
	 *
	...
	public String getQuery() {
		...
		if (endSpecified) {
			queryBuilder.append(" END " + (columnName != null ?
					columnName :
					""));
		}
