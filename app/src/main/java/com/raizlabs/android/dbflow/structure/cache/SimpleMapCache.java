 ...
 */
public class SimpleMapCache<TModel extends Model>
		extends ModelCache<TModel, Map<Object, TModel>> {

	/**
	 * Constructs new instance with a {@link HashMap} with the specified capacity.
	 *
	 * @param capacity
	 * 		The capacity to use on the hashmap.
	 */
	 ...
	 *
	 * @param cache
	 * 		The arbitrary underlying cache class.
	 */
	...
	public void setCacheSize(int size) {
		...
		FlowLog.log(
				FlowLog.Level.I,
				"The cache size for " + SimpleMapCache.class.getSimpleName() + " is not re-configurable."
				   );
	}
}
