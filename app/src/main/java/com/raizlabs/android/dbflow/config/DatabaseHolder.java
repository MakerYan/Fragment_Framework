...
public abstract class DatabaseHolder {
	...
	/**
	 * @param clazz
	 * 		The model value class to get a {@link com.raizlabs.android.dbflow.converter.TypeConverter}
	 *
	...
	public void putDatabaseForTable(Class<? extends Model> table, DatabaseDefinition databaseDefinition) {
		...
		databaseClassLookupMap.put(
				databaseDefinition.getAssociatedDatabaseClassFile(),
				databaseDefinition
								  );
	}
