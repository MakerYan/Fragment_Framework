...
public class Set<TModel extends Model>
	 ...
	 *
	 * @param conditions
	 * 		The conditions to fill the WHERE with.
	 *
	...
	public String getQuery() {
		...
		QueryBuilder queryBuilder = new QueryBuilder(update.getQuery()).append("SET ")
																	   .append(conditionGroup.getQuery())
																	   .appendSpace();
