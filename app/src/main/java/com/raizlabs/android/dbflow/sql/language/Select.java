...
public class Select
	 ...
	 *
	 * @param table
	 * 		The model table to run this query on
	 * @param <TModel>
	 * 		The class that implements {@link com.raizlabs.android.dbflow.structure.Model}
	 *
	...
	public String getQuery() {
		...
		queryBuilder.append(QueryBuilder.join(
				",",
				propertyList
											 ));
		queryBuilder.appendSpace();
	 ...
	 *
	 * @param qualifierInt
	 * 		Can be {@link #ALL}, {@link #NONE}, or {@link #DISTINCT}
	 *
	 * @return
	 */
