...
public class ValueQueryBuilder
	 ...
	 *
	 * @param modelValue
	 * 		The un-typeconverted value of the model.
	 *
	 ...
	 *
	 * @param modelList
	 * 		The list of objects that are converted into proper DB values
	 *
	 * @return
	 */
	 ...
	 *
	 * @param modelList
	 * 		The array of objects that are converted into proper DB values
	 *
	 * @return
	 */
