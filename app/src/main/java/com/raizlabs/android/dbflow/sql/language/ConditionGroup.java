...
public class ConditionGroup
	 ...
	 *
	 * @param allCommaSeparated
	 * 		All become comma separated.
	 *
	 ...
	 * 		true if we use them, false if not.
	 */
	...
	private void setPreviousSeparator(String separator) {
		...
		if (conditionsList.size() > 0) {
			...
			conditionsList.get(conditionsList.size() - 1)
						  .separator(separator);
		}
	}
