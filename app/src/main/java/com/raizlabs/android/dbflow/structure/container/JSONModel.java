...
public class JSONModel<TModel extends Model>
	 ...
	 *
	 * @param jsonObject
	 * 		The json to reference in {@link com.raizlabs.android.dbflow.structure.Model} operations
	 * @param table
	 * 		The table of the referenced model
	 */
