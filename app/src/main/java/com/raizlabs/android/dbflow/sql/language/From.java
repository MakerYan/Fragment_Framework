...
public class From<TModel extends Model>
	 ...
	 *
	 * @param querybase
	 * 		The base query we append this query to
	 * @param table
	...
	public <TJoin extends Model> Join<TJoin, TModel> join(Class<TJoin> table, @NonNull Join.JoinType joinType) {
		...
		Join<TJoin, TModel> join = new Join<>(
				this,
				table,
				joinType
		);
	...
	/**
	 * @param conditions
	 * 		The array of conditions that define this WHERE statement
	 *
