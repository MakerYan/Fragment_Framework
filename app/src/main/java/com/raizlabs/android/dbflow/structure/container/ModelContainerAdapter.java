...
public abstract class ModelContainerAdapter<TModel extends Model>
	 ...
	 * 		The container to read data from into {@link android.content.ContentValues}
	 */
	@Override
	 ...
	 *
	 * @param modelContainer
	 * 		The container to read data from into a {@link TModel}
	 *
	 ...
	 *
	 * @param modelContainer
	 * 		The model container object to store the key
	 * @param id
	 * 		The key to store
	 */
	@Override
	...
	/**
	 * @param modelContainer
	 * 		The model container object to read primary key autoincrement from
	 *
	 ...
	 *
	 * @param modelContainerLoader
	 * 		The loader used to load {@link Cursor} data into a {@link ModelContainer}.
	 */
