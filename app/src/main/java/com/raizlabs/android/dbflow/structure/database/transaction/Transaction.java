...
public final class Transaction {
	...
	public void execute() {
		...
		databaseDefinition.getTransactionManager()
						  .addTransaction(this);
	}
	...
	public static final class Builder {
		...
		/**
		 * @param transaction
		 * 		The interface that actually executes the transaction.
		 * @param databaseDefinition
		 * 		The database this transaction will run on. Should be the same
		 ...
		 * 		The callback, invoked on the UI thread.
		 */
		 ...
		 *
		 * @param name
		 * 		The name of this transaction. Should be unique for any transaction currently
		...
		/**
		 * @param shouldRunInTransaction
		 * 		True is default. If true, we run this {@link Transaction} in
		...
		/**
		 * @param runCallbacksOnSameThread
		 * 		Default is false. If true we return the callbacks from
