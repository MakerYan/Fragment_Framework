 ...
 */
public class IndexedBy<TModel extends Model>
	...
	public String getQuery() {
		...
		QueryBuilder queryBuilder = new QueryBuilder(whereBase.getQuery()).append("INDEXED BY ")
																		  .append(QueryBuilder.quoteIfNeeded(indexProperty.getIndexName()))
																		  .appendSpace();
