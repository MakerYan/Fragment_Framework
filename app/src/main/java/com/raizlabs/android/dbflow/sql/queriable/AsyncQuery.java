...
public class AsyncQuery<TModel extends Model>
		extends BaseAsyncObject<AsyncQuery<TModel>> {
	 ...
	 *
	 * @param queriable
	 * 		The queriable object to use to query data.
	 */
	...
	/**
	 * @param queryResultCallback
	 * 		Called when query is executed and has a result.
	 */
	...
	/**
	 * @param queryResultSingleCallback
	 * 		Called when query is executed and has a result.
	 */
	...
	public void execute() {
		...
		executeTransaction(new QueryTransaction.Builder<>(modelQueriable).queryResult(queryResultCallback)
