...
public class SQLite {
	...
	/**
	 * @param properties
	 * 		The properties/columns to SELECT.
	 *
	 ...
	 *
	 * @param properties
	 * 		Optional, if specified returns the count of non-null ROWs from a specific single/group of columns.
	 *
	 ...
	 *
	 * @param condition
	 * 		The condition to check for in the WHEN.
	 *
