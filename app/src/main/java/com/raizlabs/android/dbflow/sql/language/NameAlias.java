...
public class NameAlias
	 ...
	 *
	 * @param operation
	 * 		The operation to separate into.
	 * @param names
	 * 		The names to join.
	 *
	...
	public static Builder rawBuilder(String name) {
		...
		return new Builder(name).shouldStripIdentifier(false)
	...
	public String aliasNameRaw() {
		...
		return shouldStripAliasName ?
				aliasName :
				QueryBuilder.stripQuotes(aliasName);
	}
	...
	public String fullName() {
		...
		return (StringUtils.isNotNullOrEmpty(tableName) ?
				(tableName() + ".") :
				"") + name();
	}
	...
	public Builder newBuilder() {
		...
		return new Builder(name).keyword(keyword)
								.as(aliasName)
	...
	public static class Builder {
		...
		/**
		 * @param shouldStripIdentifier
		 * 		If true, we normalize the identifier {@link #name} from any
		...
		/**
		 * @param shouldStripAliasName
		 * 		If true, we normalize the identifier {@link #aliasName} from any
		 * 		ticks around the name. If false, we leave it as such.
		 */
		...
		/**
		 * @param shouldAddIdentifierToName
		 * 		If true (default), we add the identifier to the name: `{name}`
		 */
		...
		/**
		 * @param shouldAddIdentifierToAliasName
		 * 		If true (default), we add an identifier to the alias
		 * 		name. `{aliasName}`
		 */
