...
public class PriorityTransactionQueue
	 ...
	 *
	 * @param transaction
	 * 		The transaction to cancel (if still in the queue).
	 */
	@Override
	...
	private void throwInvalidTransactionType(Transaction transaction) {
		...
		throw new IllegalArgumentException("Transaction of type:" + (transaction != null ?
				transaction.transaction()
						   .getClass() :
				"Unknown") + " should be of type PriorityTransactionWrapper");
	}
	...
	class PriorityEntry<E extends Transaction>
		...
		public PriorityEntry(E entry) {
			...
			if (entry.transaction() instanceof PriorityTransactionWrapper) {
				...
				transactionWrapper = new PriorityTransactionWrapper.Builder(entry.transaction()).build();
			}
		}
		...
		public boolean equals(Object o) {
			...
			return transactionWrapper != null ?
					transactionWrapper.equals(that.transactionWrapper) :
