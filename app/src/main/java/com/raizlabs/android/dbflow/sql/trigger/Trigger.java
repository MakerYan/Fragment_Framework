...
public class Trigger
	 ...
	 *
	 * @param triggerName
	 * 		What we should call this trigger
	 */
	 ...
	 * 		The table ON
	 * @param properties
	 * 		if empty, will not execute an OF command. If you specify columns,
	...
	public String getQuery() {
		...
		queryBuilder.append("TRIGGER IF NOT EXISTS ")
					.appendQuotedIfNeeded(triggerName)
					.appendSpace()
