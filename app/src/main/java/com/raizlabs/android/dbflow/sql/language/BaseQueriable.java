 ...
 */
public abstract class BaseQueriable<TModel extends Model>
	...
	public long count() {
		...
		return count(FlowManager.getDatabaseForTable(getTable())
								.getWritableDatabase());
	}
	...
	public Cursor query() {
		...
		query(FlowManager.getDatabaseForTable(table)
						 .getWritableDatabase());
		return null;
	}
	...
	public DatabaseStatement compileStatement() {
		...
		return compileStatement(FlowManager.getDatabaseForTable(table)
										   .getWritableDatabase());
	}
	...
	public DatabaseStatement compileStatement(DatabaseWrapper databaseWrapper) {
		...
		FlowLog.log(
				FlowLog.Level.V,
				"Compiling Query Into Statement: " + query
				   );
