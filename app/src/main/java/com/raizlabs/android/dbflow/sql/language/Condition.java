...
public class Condition
	...
	public static String convertValueToString(Object value) {
		...
		return BaseCondition.convertValueToString(
				value,
				false
												 );
	}
	...
	public void appendConditionToQuery(QueryBuilder queryBuilder) {
		...
		if (isValueSet) {
			queryBuilder.append(BaseCondition.convertValueToString(
					value(),
					true
																  ));
		}
	 ...
	 *
	 * @param value
	 * 		Uses sqlite LIKE regex to match rows.
	 ...
	 *
	 * @param value
	 * 		Uses sqlite GLOB regex to match rows.
	 * 		It must be a string to escape it properly.
	 ...
	 *
	 * @param value
	 * 		The value of the column in the DB
	 *
	 * @return This condition
	 */
	...
	public In notIn(BaseModelQueriable firstBaseModelQueriable, BaseModelQueriable[] baseModelQueriables) {
		...
		return notIn(
				firstBaseModelQueriable,
				(Object[]) baseModelQueriables
					);
	}
	...
	public Condition concatenate(Object value) {
		...
		operation = new QueryBuilder(Operation.EQUALS).append(columnName())
													  .toString();
		if (value != null) {
	...
	public static class Between
		...
		public void appendConditionToQuery(QueryBuilder queryBuilder) {
			...
			queryBuilder.append(columnName())
						.append(operation())
						.append(BaseCondition.convertValueToString(
								value(),
								true
																  ))
	...
	public static class In
		 ...
		 *
		 * @param condition
		 * 		The condition object to pass in. We only use the column name here.
		 * @param firstArgument
		 * 		The first value in the IN query as one is required.
		 * @param isIn
		 * 		if this is an {@link Condition.Operation#IN}
		 ...
		 *
		 * @param argument
		 * 		The non-type converted value of the object. The value will be converted
		...
		public void appendConditionToQuery(QueryBuilder queryBuilder) {
			...
			queryBuilder.append(columnName())
						.append(operation())
						.append("(")
						.append(ConditionGroup.joinArguments(
								",",
								inArguments
															))
						.append(")");
