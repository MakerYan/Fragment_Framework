...
public class FastStoreModelTransaction<TModel extends Model>
	...
	interface ProcessModelList<TModel extends Model> {
		 ...
		 *
		 * @param modelList
		 * 		The model list to process
		 */
		void processModel(@NonNull List<TModel> modelList, InternalAdapter<TModel> adapter, DatabaseWrapper wrapper);
	}
