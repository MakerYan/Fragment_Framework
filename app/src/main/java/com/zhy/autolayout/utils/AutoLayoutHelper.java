...
public class AutoLayoutHelper {
	...
	public static AutoLayoutInfo getAutoLayoutInfo(Context context, AttributeSet attrs) {
		...
		for (int i = 0; i < n; i++) {
			...
			int pxVal = 0;
			try {
				pxVal = array.getDimensionPixelOffset(
						index,
						0
													 );
			...
			switch (index) {
				...
				case INDEX_PADDING_LEFT:
					info.addAttr(new PaddingLeftAttr(
							pxVal,
							baseWidth,
							baseHeight
					));
				...
				case INDEX_PADDING_TOP:
					info.addAttr(new PaddingTopAttr(
							pxVal,
							baseWidth,
							baseHeight
					));
				...
				case INDEX_PADDING_RIGHT:
					info.addAttr(new PaddingRightAttr(
							pxVal,
							baseWidth,
							baseHeight
					));
				...
				case INDEX_PADDING_BOTTOM:
					info.addAttr(new PaddingBottomAttr(
							pxVal,
							baseWidth,
							baseHeight
					));
				...
				case INDEX_MARGIN_LEFT:
					info.addAttr(new MarginLeftAttr(
							pxVal,
							baseWidth,
							baseHeight
					));
				...
				case INDEX_MARGIN_TOP:
					info.addAttr(new MarginTopAttr(
							pxVal,
							baseWidth,
							baseHeight
					));
				...
				case INDEX_MARGIN_RIGHT:
					info.addAttr(new MarginRightAttr(
							pxVal,
							baseWidth,
							baseHeight
					));
				...
				case INDEX_MARGIN_BOTTOM:
					info.addAttr(new MarginBottomAttr(
							pxVal,
							baseWidth,
							baseHeight
					));
				...
				case INDEX_MAX_HEIGHT:
					info.addAttr(new MaxHeightAttr(
							pxVal,
							baseWidth,
							baseHeight
					));
				...
				case INDEX_MIN_HEIGHT:
					info.addAttr(new MinHeightAttr(
							pxVal,
							baseWidth,
							baseHeight
					));
