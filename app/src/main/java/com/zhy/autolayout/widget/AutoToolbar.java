...
public class AutoToolbar
	...
	public AutoToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		int menuTextAppearance = menuA.getResourceId(
	...
	private void setUpTitleTextSize(String name, int val) {
		...
		try {
			...
			Field f = getClass().getSuperclass()
	...
	public static class LayoutParams
		...
		public LayoutParams(Context c, AttributeSet attrs) {
			...
			this.mDimenLayoutInfo = AutoLayoutHelper.getAutoLayoutInfo(
					c,
					attrs
																	  );
		}
