...
public class DialogPlus {
	...
	DialogPlus(DialogPlusBuilder builder) {
		...
		if (builder.isExpanded()) {
			initExpandAnimator(
					activity,
					builder.getDefaultContentHeight(),
	...
	private View createView(LayoutInflater inflater, View headerView, View footerView, BaseAdapter adapter) {
		...
		if (holder instanceof ViewHolder || holder instanceof ViewDataBindingHolder) {
	...
	private void setClickListener(View view) {
		...
		view.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (holder instanceof ViewDataBindingHolder) {
					ViewDataBindingHolder viewDataBindingHolder = (ViewDataBindingHolder) holder;
					onClickListener.onClick(
							DialogPlus.this,
							v,
							viewDataBindingHolder.getViewDataBinding()
										   );
				}
			}
		});
