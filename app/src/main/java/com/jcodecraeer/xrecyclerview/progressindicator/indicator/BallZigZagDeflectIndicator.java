...
public class BallZigZagDeflectIndicator
		extends com.jcodecraeer.xrecyclerview.progressindicator.indicator.BallZigZagIndicator {
	...
	public List<Animator> createAnimation() {
		...
		for (int i = 0; i < 2; i++) {
			final int index = i;
			ValueAnimator translateXAnim = ValueAnimator.ofFloat(
					startX,
					getWidth() - startX,
					startX,
					getWidth() - startX,
			...
			ValueAnimator translateYAnim = ValueAnimator.ofFloat(
					startY,
					startY,
					getHeight() - startY,
					getHeight() - startY,
