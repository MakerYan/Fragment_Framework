...
public class PacmanIndicator
	...
	public List<Animator> createAnimation() {
		...
		ValueAnimator translationAnim = ValueAnimator.ofFloat(
				getWidth() - startT,
				getWidth() / 2
															 );
		...
		ValueAnimator alphaAnim = ValueAnimator.ofInt(
				255,
				122
													 );
		...
		ValueAnimator rotateAnim1 = ValueAnimator.ofFloat(
				0,
				45,
				0
														 );
		...
		ValueAnimator rotateAnim2 = ValueAnimator.ofFloat(
				0,
				-45,
				0
														 );
