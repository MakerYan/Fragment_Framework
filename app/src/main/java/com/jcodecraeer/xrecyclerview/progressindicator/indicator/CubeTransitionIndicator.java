...
public class CubeTransitionIndicator
	...
	public List<Animator> createAnimation() {
		...
		for (int i = 0; i < 2; i++) {
			...
			ValueAnimator translationXAnim = ValueAnimator.ofFloat(
					startX,
					getWidth() - startX,
					getWidth() - startX,
					startX,
			...
			ValueAnimator translationYAnim = ValueAnimator.ofFloat(
					startY,
					startY,
					getHeight() - startY,
					getHeight() - startY,
		...
		ValueAnimator scaleAnim = ValueAnimator.ofFloat(
				1,
				0.5f,
				1,
				0.5f,
		...
		ValueAnimator rotateAnim = ValueAnimator.ofFloat(
				0,
				180,
				360,
				1.5f * 360,
