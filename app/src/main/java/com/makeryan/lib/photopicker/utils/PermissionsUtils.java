package com.makeryan.lib.photopicker.utils;
...
public class PermissionsUtils {
	...
	/**
	 * @see Manifest.permission_group#CALENDAR
	 */
	public static final int REQUEST_CODE_GROUP_CALENDAR = 4031;

	/**
	 * @see Manifest.permission_group#CAMERA
	 */
	public static final int REQUEST_CODE_GROUP_CAMERA = 4032;

	/**
	 * @see Manifest.permission_group#CONTACTS
	 */
	public static final int REQUEST_CODE_GROUP_CONTACTS = 4033;

	/**
	 * @see Manifest.permission_group#LOCATION
	 */
	public static final int REQUEST_CODE_GROUP_MICROPHONE = 4034;

	/**
	 * @see Manifest.permission_group#PHONE
	 */
	public static final int REQUEST_CODE_GROUP_PHONE = 4035;

	/**
	 * @see Manifest.permission_group#SENSORS
	 */
	public static final int REQUEST_CODE_GROUP_SENSORS = 4036;

	/**
	 * @see Manifest.permission_group#SMS
	 */
	public static final int REQUEST_CODE_GROUP_SMS = 4037;

	/**
	 * @see Manifest.permission_group#STORAGE
	 */
	public static final int REQUEST_CODE_GROUP_STORAGE = 4038;

	/**
	 * @see Manifest.permission_group#MICROPHONE
	 */
	public static final int REQUEST_CODE_GROUP_LOCATION = 4039;

	/**
	 * @see android.Manifest.permission#WRITE_CONTACTS
	 */
	public static final int REQUEST_CODE_WRITE_CONTACTS = 4040;

	/**
	 * @see android.Manifest.permission#GET_ACCOUNTS
	 */
	public static final int REQUEST_CODE_GET_ACCOUNTS = 4041;

	/**
	 * @see android.Manifest.permission#READ_CONTACTS
	 */
	public static final int REQUEST_CODE_READ_CONTACTS = 4042;

	/**
	 * @see android.Manifest.permission#READ_CALL_LOG
	 */
	public static final int REQUEST_CODE_READ_CALL_LOG = 4043;

	/**
	 * @see android.Manifest.permission#READ_PHONE_STATE
	 */
	public static final int REQUEST_CODE_READ_PHONE_STATE = 4044;

	/**
	 * @see android.Manifest.permission#CALL_PHONE
	 */
	public static final int REQUEST_CODE_CALL_PHONE = 4045;

	/**
	 * @see android.Manifest.permission#WRITE_CALL_LOG
	 */
	public static final int REQUEST_CODE_WRITE_CALL_LOG = 4046;

	/**
	 * @see android.Manifest.permission#USE_SIP
	 */
	public static final int REQUEST_CODE_USE_SIP = 4047;

	/**
	 * @see android.Manifest.permission#PROCESS_OUTGOING_CALLS
	 */
	public static final int REQUEST_CODE_PROCESS_OUTGOING_CALLS = 4048;

	/**
	 * @see android.Manifest.permission#ADD_VOICEMAIL
	 */
	public static final int REQUEST_CODE_ADD_VOICEMAIL = 4049;

	/**
	 * @see android.Manifest.permission#READ_CALENDAR
	 */
	public static final int REQUEST_CODE_READ_CALENDAR = 4050;

	/**
	 * @see android.Manifest.permission#WRITE_CALENDAR
	 */
	public static final int REQUEST_CODE_WRITE_CALENDAR = 4051;

	/**
	 * @see android.Manifest.permission#CAMERA
	 */
	public static final int REQUEST_CODE_CAMERA = 4052;

	/**
	 * @see android.Manifest.permission#BODY_SENSORS
	 */
	public static final int REQUEST_CODE_BODY_SENSORS = 4053;

	/**
	 * @see android.Manifest.permission#ACCESS_FINE_LOCATION
	 */
	public static final int REQUEST_CODE_ACCESS_FINE_LOCATION = 4054;

	/**
	 * @see android.Manifest.permission#ACCESS_COARSE_LOCATION
	 */
	public static final int REQUEST_CODE_ACCESS_COARSE_LOCATION = 4055;

	/**
	 * @see android.Manifest.permission#READ_EXTERNAL_STORAGE
	 */
	public static final int REQUEST_CODE_READ_EXTERNAL_STORAGE = 4056;

	/**
	 * @see android.Manifest.permission#WRITE_EXTERNAL_STORAGE
	 */
	public static final int REQUEST_CODE_WRITE_EXTERNAL_STORAGE = 4057;

	/**
	 * @see android.Manifest.permission#RECORD_AUDIO
	 */
	public static final int REQUEST_CODE_RECORD_AUDIO = 4058;

	/**
	 * @see android.Manifest.permission#READ_SMS
	 */
	public static final int REQUEST_CODE_READ_SMS = 4059;

	/**
	 * @see android.Manifest.permission#RECEIVE_WAP_PUSH
	 */
	public static final int REQUEST_CODE_RECEIVE_WAP_PUSH = 4060;

	/**
	 * @see android.Manifest.permission#RECEIVE_MMS
	 */
	public static final int REQUEST_CODE_RECEIVE_MMS = 4061;

	/**
	 * @see android.Manifest.permission#RECEIVE_SMS
	 */
	public static final int REQUEST_CODE_RECEIVE_SMS = 4062;

	/**
	 * @see android.Manifest.permission#SEND_SMS
	 */
	public static final int REQUEST_CODE_SEND_SMS = 4063;
	 ...
	 * @return
	 */
	public static boolean checkPermission(Activity activity, String stringPermission) {
	 ...
	 * @return
	 */
	public static boolean checkPermission(Fragment fragment, String stringPermission) {
	...
	public static void requestPermission(Activity activity, int requestCode, String... arrPermission) {
	...
	public static void requestPermission(Fragment fragment, int requestCode, String... arrPermission) {
