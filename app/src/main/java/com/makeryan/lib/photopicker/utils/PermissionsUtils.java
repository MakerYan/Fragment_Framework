...
public class PermissionsUtils {
	...
	public static boolean checkReadStoragePermission(Activity activity) {
		...
		int readStoragePermissionState = ContextCompat.checkSelfPermission(
				activity,
	...
	public static boolean checkWriteStoragePermission(Fragment fragment) {
		...
		int writeStoragePermissionState = ContextCompat.checkSelfPermission(
				fragment.getContext(),
	...
	public static boolean checkCameraPermission(Fragment fragment) {
		...
		int cameraPermissionState = ContextCompat.checkSelfPermission(
				fragment.getContext(),
				CAMERA
																	 );
