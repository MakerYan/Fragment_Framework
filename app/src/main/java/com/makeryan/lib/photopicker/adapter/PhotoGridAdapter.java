...
import com.makeryan.lib.photopicker.event.OnPhotoClickListener;
...
public class PhotoGridAdapter
		extends SelectableAdapter<PhotoGridAdapter.PhotoViewHolder> {
			...
			holder.vSelected.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					...
					if (onItemCheckListener != null) {
						isEnable = onItemCheckListener.onItemCheck(
								pos,
								photo,
								getSelectedPhotos().size() + (isSelected(photo) ?
										-1 :
										1)
																  );
					}
	...
	public int getItemCount() {
		...
		int photosCount = photoDirectories.size() == 0 ?
				0 :
	...
	public static class PhotoViewHolder
		...
		public PhotoViewHolder(View itemView) {
			...
			vSelected = itemView.findViewById(R.id.ivSelected);
		}
	}
