 ...
 */
public class WrapLayoutFunction
		extends ViewGroup {
	...
	public WrapLayoutFunction(Context context) {
	...
	public WrapLayoutFunction(Context context, AttributeSet attrs) {
	...
	@TargetApi(11)
	public WrapLayoutFunction(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	@TargetApi(21)
	public WrapLayoutFunction(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
	...
	public static class LayoutParams
		...
		private int mGravity = WrapLayoutFunction.GRAVITY_PARENT;
		...
		public LayoutParams(Context c, AttributeSet attrs) {
			...
			int gravity = WrapLayoutFunction.GRAVITY_PARENT;
