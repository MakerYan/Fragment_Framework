...
/**
 * Created by Maker on 16/11/4.
 */

public class GridLayoutManagerPlus
	...
	private void measureScrapChild(RecyclerView.Recycler recycler, int position, int widthSpec, int heightSpec, int[] measuredDimension) {
		...
		if (position < getItemCount() && (position >= firstVisibleItemPosition || position <= lastVisibleItemPosition)) {*/
