...
public class BottomBar
	...
	private List<BaseBottomBarTab> mTabs = new ArrayList<>();
	...
	public BottomBar addItem(final BaseBottomBarTab tab) {

		recursionSetClickListener(
				tab,
				tab
								 );
	...
	private void recursionSetClickListener(BaseBottomBarTab tab, View view) {
	 ...
	 * 获取 Tab
	 */
	public BaseBottomBarTab getItem(int index) {
	...
	protected void onRestoreInstanceState(Parcelable state) {
		...
		if (mCurrentPosition != ss.position) {
			mTabLayout.getChildAt(mCurrentPosition)
					  .setSelected(false);
			mTabLayout.getChildAt(ss.position)
					  .setSelected(true);
		}
