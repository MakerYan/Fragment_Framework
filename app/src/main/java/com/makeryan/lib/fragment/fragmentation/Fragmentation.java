...
import com.makeryan.lib.fragment.fragmentation.helper.internal.InstanceException;
...
public class Fragmentation {
	...
	public static class FragmentationBuilder {
		...
		/**
		 * @param debug
		 * 		Suppressed Exception("Can not perform this action after onSaveInstanceState!") when debug=false
		 */
		...
		/**
		 * @param handler
		 * 		Handled Exception("Can not perform this action after onSaveInstanceState!") when debug=false.
		 */
