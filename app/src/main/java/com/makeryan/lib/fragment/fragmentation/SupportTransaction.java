...
public abstract class SupportTransaction {
	...
	/**
	 * @param launchMode
	 * 		Can replace {@link SupportFragment#start(SupportFragment, int)}
	 * 		<p>
	 ...
	 *
	 * @param with
	 * 		return true if you need pop currentFragment
	 *
	 * @return the same SupportTransaction instance.
	 */
	 ...
	 * or SupportActivity/SupportFragment.startXXX()}
	 */
	final static class SupportTransactionImpl<T extends SupportFragment>
			extends SupportTransaction {
		...
		public SupportTransaction addSharedElement(View sharedElement, String sharedName) {
			...
			mRecord.sharedElementList.add(new TransactionRecord.SharedElement(
					sharedElement,
					sharedName
			));
			return this;
