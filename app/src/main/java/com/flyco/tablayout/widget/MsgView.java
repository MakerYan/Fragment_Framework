...
public class MsgView
	...
	private void obtainAttributes(Context context, AttributeSet attrs) {
		...
		backgroundColor = ta.getColor(
				R.styleable.MsgView_mv_backgroundColor,
				Color.TRANSPARENT
									 );
		cornerRadius = ta.getDimensionPixelSize(
				R.styleable.MsgView_mv_cornerRadius,
				0
											   );
		strokeWidth = ta.getDimensionPixelSize(
				R.styleable.MsgView_mv_strokeWidth,
				0
											  );
		strokeColor = ta.getColor(
				R.styleable.MsgView_mv_strokeColor,
				Color.TRANSPARENT
								 );
		...
		isWidthHeightEqual = ta.getBoolean(
				R.styleable.MsgView_mv_isWidthHeightEqual,
				false
										  );
	...
	protected int sp2px(float sp) {
		...
		final float scale = this.context.getResources()
